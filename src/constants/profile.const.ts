...
> &
  ...
  description:
    'Ingeniero de Sistemas con más de 4 años de experiencia en tecnologías frontend (React, Next.js, Ionic y Angular). Trabajo en aplicaciones web y móviles desde su definición técnica hasta su construcción y publicación, con foco en la experiencia del usuario.',
